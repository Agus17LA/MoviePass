        ...
        <ul>
            <?php if($allPurchases){
                ...
                <li id="liDatsP"> 
                    ...
                    <p> MovieTheater: <?php echo $this->movieTheaterDao->read($this->showDao->read($value->getId_show())->getId_movieTheater())->getName(); ?> </p>
                    <p> Number of cinema: <?php echo $this->cinemaDao->read($this->showDao->read($value->getId_show())->getId_cinema())->getNumberCinema(); ?> </p>
