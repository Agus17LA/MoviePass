...
<header >
        ...
        <div id="container"> 
            <h1 id="titleCinemas">MovieTheater: <?php echo $MT->getName(); ?></h1>
            <form action="<?php echo FRONT_ROOT ?>Show/verifyHour"> <br>
                Cinema:
                <select name="id_cinema" id="selectCinema" required>
