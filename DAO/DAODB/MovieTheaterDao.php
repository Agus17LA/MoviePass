<?php namespace DAO\DAODB;
    ...
    class MovieTheaterDao extends Singleton implements IDao{
        ...
        public function readByMovie($id_movie){
            $sql = "SELECT mt.id_movieTheater,mt.name,mt.adress,mt.available,mt.numberOfCinemas FROM movietheater mt INNER JOIN shows s ON mt.id_movieTheater = s.id_movieTheater INNER JOIN cinemas c ON s.id_cinema = c.id_cinema WHERE c.available = 1 AND s.id_movie = :id_movie GROUP BY mt.id_movieTheater;";
